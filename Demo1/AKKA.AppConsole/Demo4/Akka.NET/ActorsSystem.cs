...
namespace AKKA.Demo.Library
{
    ...
    {
        public static readonly ConcurrentDictionary<ActorReference, IActorRef> Actors;
        ...
        static ActorsSystem()
        {
            Actors = new ConcurrentDictionary<ActorReference, IActorRef>();
        ...
        public static bool Remove(ActorReference reference, IActorRef act)
        {
